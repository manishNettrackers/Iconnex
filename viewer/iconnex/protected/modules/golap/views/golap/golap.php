...
<div class="big-corners" id="bigloading">Please Wait ..</div>

<div id="mapping" style="width: 100%; height: 100%">
...
<!--<div style="float: left; height: 100%">
	<input style="display:inline" class="hidefeature" type="button" id="showsidebar" title="Show Sidebar" style="float: left"/>
</div> Change By Designer-->

<!-- Map container -->
<div id="visualizer" style="height: 90%; padding-left: 4px; width: 80%; float: left;">
