...
function s1howSubwindow(link, targetwindow)
{
	var url = link.href;
...
<div class="big-corners" id="bigloading">Loading ..<BR>Please Wait ..</div>
...
<div id="debug" style="width:100%"></div>
	<div id="selectmenu" style="width:100%; display: block; margin-bottom: 10px">
...
<div id="mapping" style="width: 100%; height: 1600px">
    <div id="criteriacol" class="ui-widget-content" style="height: 100%;margin-left: 5px; padding-right: 0px; width: 20%; float: left; height=100%">
		...
		<div id="menubuttons" class="ui-state-normal">
		</div>
