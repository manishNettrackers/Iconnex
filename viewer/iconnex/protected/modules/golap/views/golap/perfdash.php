...
<LINK id="reportico_css" REL="stylesheet" TYPE="text/css" HREF="js/ui/themes/ui-darkness/jquery.ui.all.css">
<LINK id="reportico_css" REL="stylesheet" TYPE="text/css" HREF="css/ui-darkness/jquery-ui-1.8.16.custom.css">
<LINK id="reportico_css" REL="stylesheet" TYPE="text/css" HREF="js/ui/themes/ui-darkness/jquery.ui.tabs.css">
<LINK id="reportico_css" REL="stylesheet" TYPE="text/css" HREF="js/ui/themes/ui-darkness/dashboardui.css">
...
echo " var menuCode = 'Performance Dashboard';";
echo " var baseUrl = '";
get_app_url();
echo "';";
...
<div id="debug" style="width:100%"></div>
	<div id="selectmenu" style="width:100%; display: inline; margin-bottom: 10px">
		<form action="#" id="toolbarform" style="width:100%; display: block;">
			<select name="adminmenu" id="adminmenu" style="float: left" class="ui-helper-reset ui-state-default  ui-corner-top" onChange="handleUserMenuChange(this);">
				<option class="ui-stsate-active">Select Option</option>
			</select>
    	<input type="button" id="showgrid" title="Show Data Grid" value=""  style="float: left"/>
    	<input type="button" id="showmap" title="Show Map" style="float: left"/>
    	<!--input type="button" id="showlinecol" title="Show Line View" style="float: right"/-->
    	<input type="button" id="showdashboard" title="Show Dashboard" style="float: left"/>
...
<div id="mapping" style="width: 100%; height: 1600px">
    <div id="criteriacol" class="ui-widget-content" style="height: 100%;margin-left: 5px; padding-right: 0px; width: 20%; float: left; height=100%">
                <!--div id="results" class="list">
                    <div style="font-size:medium">
                        <br/>Select a mapping visualization from the above options
                    </div>
                </div-->
		<div id="accordiontitle" class="ui-widget-header ui-state-active">
            Query Control Panel
		</div>
		<div id="menubuttons" class="ui-state-normal" style="display: none">
		</div>
		<div id="accordion" class="ui-state-active">
		</div>
    </div>
...
<div id="mapcol" style="height: 90%; margin: 0px 0px 0px 0px; display: none; width: 100%; float: left;">
    <div id="mstatus" class="stattxt"></div>
    <div id="mstatus2" class="stattxt"></div>
    <div id="map">Loading map...</div>
</div>
<div id="dashboardcol" style="margin: 0px 0px 0px 0px; display: inline; width: 100%; float: left;">
