<?php
$this->menu=array(
    array('label'=>'Back to Subscribers', 'url'=>array('subscriber/admin')),
);
?>
<div>
...
<table width="100%">
        ...
        <th width="50%" colspan="2">Choose subscription locations for
            <?php
    ...
    <tr>
        <td width="50%" rowspan="2">
            <div id="locations">
                <?php
                    $this->renderPartial('locations', array('model'=>$model, 'message' => $message, 'data'=>$data));
                ?>
            </div>
        </td>
    </tr>
