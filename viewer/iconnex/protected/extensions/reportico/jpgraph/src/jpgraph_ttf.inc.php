...
// Created:     2006-11-19
// Ver:         $Id: jpgraph_ttf.inc.php,v 1.3 2012-08-30 19:22:28 root Exp $
//
...
//Reportico Fonts
define("advent_light", 100);
define("Bedizen", 101);
define("calibri", 102);
define("Forgotte", 103);
define("GeosansLight", 104);
define("MankSans", 105);
define("Mukti_Narrow", 106);
define("pf_arma_five", 107);
define("Silkscreen", 108);
define("verdana", 109);

// Limits for fonts
define("_FIRST_FONT",10);
define("_LAST_FONT",109);
...
class TTF {
    ...
    function __construct() {
	    ...
	    */
	    ...
	    advent_light => array(
	    	FS_NORMAL =>'advent_light.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    Bedizen => array(
	    	FS_NORMAL =>'Bedizen.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    calibri => array(
	    	FS_NORMAL =>'calibri.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    Forgotte => array(
	    	FS_NORMAL =>'Forgotte.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    GeosansLight => array(
	    	FS_NORMAL =>'GeosansLight.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    Mukti_Narrow => array(
	    	FS_NORMAL =>'Mukti_Narrow.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    MankSans => array(
	    	FS_NORMAL =>'MankSans.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    pf_arma_five => array(
	    	FS_NORMAL =>'pf_arma_five.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),

	    Silkscreen => array(
	    	FS_NORMAL =>'Silkscreen.ttf',
	    	FS_BOLD =>'',
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),
    ...
    function File($family,$style=FS_NORMAL) {
        ...
        $of = $f;
        $f = find_best_location_in_include_path( $f );
        if ( !$f )
            $f = $of;
