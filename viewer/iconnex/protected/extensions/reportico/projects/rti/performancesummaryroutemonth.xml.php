...
$groupday = $_criteria["groupday"]->get_criteria_value("VALUE");
...
$daysumcol = "extend(day, year to month)";
$mapsumcol = "' '";
if ( $groupday )
{
    $daysumcol = "'ALL'";
...
$sql="
UPDATE t_tripsum SET trip_performance_little = ( act01count  / schcount ) * 100 WHERE actcount > 0; 
...
if ( $col->query_name == "cumperc" ) $col->attributes["column_display"] = "hide";
//if ( $col->query_name == "schcount" ) $col->attributes["ColumnWidthPDF"] = "5cm";
...
//if ( $col->query_name == "act01count" ) $col->attributes["ColumnWidthPDF"] = "5cm";
...
//if ( $col->query_name == "pb_route" ) $col->attributes["ColumnWidthPDF"] = "5cm";
...
if ( $col->query_name == "minvehcode" ) $col->attributes["column_display"] = "hide";
if ( $col->query_name == "act06count" ) $col->attributes["column_display"] = "hide";
if ( $col->query_name == "act01count" ) $col->attributes["column_display"] = "hide";
if ( $col->query_name == "act01tot" ) $col->attributes["column_display"] = "hide";
if ( $col->query_name == "operator_code" ) $col->attributes["column_display"] = "hide";
if ( $col->query_name == "pb_route" ) $col->attributes["column_display"] = "show";
