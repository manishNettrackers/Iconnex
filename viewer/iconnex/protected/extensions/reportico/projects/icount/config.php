...
define('SW_DB_DRIVER',  ICX_ODS_DB_DRIVER2);
define('SW_DB_USER', ICX_ODS_DB_USER);
define('SW_DB_PASSWORD', ICX_ODS_DB_PASSWORD);
define('SW_DB_HOST', ICX_ODS_DB_HOST);
define('SW_DB_DATABASE', ICX_ODS_DB_NAME);
define('SW_DB_SERVER', '');
...
define('SW_OUTPUT_ENCODING', 'None');
