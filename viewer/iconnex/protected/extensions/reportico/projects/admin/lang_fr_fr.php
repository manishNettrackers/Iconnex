...
L'adresse IP ou le nom de l'hôte sur lequel réside la base de données. Pour une base de données sur la même machine que le serveur web 127.0.0.1 utilisation. Pour les bases de données SQLite entrez le chemin vers le fichier base de données ici et le nom du fichier le champ Nom de la base de données. Pour les bases de données PostgreSQL Oracle, Mysql, à l'écoute sur un port non standard, vous pouvez préciser dans le formulaire hostname: port ou IPADDRESS: PORT
<P>
<b>Nom de la base</b><br>
Le nom de la base de données à signaler contre. Pour SQLite bases de données entrez le nom du fichier ici et le chemin à la résiliation slash dans le champ Nom d'hôte.
<P>
