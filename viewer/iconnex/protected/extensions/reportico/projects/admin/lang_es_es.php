...
La dirección IP o el nombre del host donde reside la base de datos. Para una base de datos en la misma máquina que el servidor web de uso 127.0.0.1. Para bases de datos SQLite introduzca la ruta al archivo de base de datos de aquí y el nombre del archivo en el campo Nombre de base de datos. Para bases de datos PostgreSQL Oracle, MySQL, escuchando en un puerto no estándar, puede especificar en la forma hostname: puerto o IP address: PUERTO
<P>
<b>Nombre de base de datos</b><br>
El nombre de la base de datos para informar en contra. Para bases de datos SQLite escriba el nombre del archivo aquí y el camino con la terminación de barra en el campo Nombre de host.
<P>
