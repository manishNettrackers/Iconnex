...
<b>主机名：端口号</b><br>
数据库所在的主机的IP地址或名称。 127.0.0.1作为网络服务器使用同一台机器上的数据库。对于SQLite数据库输入数据库文件的路径和文件名“数据库名称”字段中。对于甲骨文，MySQL和PostgreSQL数据库的非标准端口上侦听，你可以指定形式的主机名称：端口或IP地址：端口
<P>

的<b>数据库名称</b><br>参考
报告对数据库的名称。对于SQLite数据库进入这里的文件名和路径，在“主机名”字段终止斜线。
