...
The IP address or the name of the host where the database resides. For a database on the same machine as the webserver use 127.0.0.1.  For SQLite databases enter the path to the database file here and the filename the Database Name field. For Oracle, Mysql, PostgreSQL databases listening on a non-standard port, you can specify in the form HOSTNAME:PORT or IPADDRESS:PORT
<P> 

<b>Database Name</b><br>
The name of the database to report against. For SQLite databases enter the file name here and the path with terminating slash in the Host Name field. 
