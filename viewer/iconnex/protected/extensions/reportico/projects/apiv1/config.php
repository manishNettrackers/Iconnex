...
define('SW_CONFIG_locations_datalabel', 'Locations');
define('SW_CONFIG_locations_datalinelabel', 'Location');
define('SW_CONFIG_services_datalabel', 'Services');
define('SW_CONFIG_services_datalinelabel', 'Service');

$t = microtime(true);
$micro = sprintf("%06d", ($t - floor($t)) * 1000000);
$datetime = new DateTime(date('Y-m-d H:i:s.'.$micro, $t));

define('SW_CONFIG_locations_apiheader_Identifier', "locations");
define('SW_CONFIG_locations_apiheader_DisplayTitle', "Locations");
define('SW_CONFIG_locations_apiheader_PublishDateTime', substr($datetime->format("D d M Y H:i:s.u"), 0, -3));
define('SW_CONFIG_locations_apiheader_Canonical', substr($datetime->format("Y-m-d H:i:s.u"), 0, -3));
define('SW_CONFIG_locations_apiheader_Author', "api@connexionzuk.com");
define('SW_CONFIG_locations_apiheader_Owner', "Reading Borough Council");
define('SW_CONFIG_locations_apiheader_RefreshRate', "604800");
define('SW_CONFIG_locations_apiheader_Max_Latency', "86400");
define('SW_CONFIG_locations_apiheader_TimeToError', "1209600");
define('SW_CONFIG_locations_apiheader_Schedule', "Once a week");
define('SW_CONFIG_locations_apiheader_OverrideMessage', "Due to unforeseen circumstances, this feed is currently not publishable.");
define('SW_CONFIG_locations_apiheader_ErrorMessage', "Due to unforeseen circumstances, this feed is currently not available.");
define('SW_CONFIG_locations_apiheader_FeedInfo', "");
define('SW_CONFIG_locations_apiheader_AttributionUrl', "http://www.reading-travelinfo.co.uk/");
define('SW_CONFIG_locations_apiheader_AttributionText', "(c) RBC");
define('SW_CONFIG_locations_apiheader_AttributionLogo', "http://www.reading-travelinfo.co.uk/images/CompanyLogos/rbclogo.gif");
define('SW_CONFIG_locations_apiheader_Language', "EN");

define('SW_CONFIG_services_apiheader_Identifier', "services");
define('SW_CONFIG_services_apiheader_DisplayTitle', "Services");
define('SW_CONFIG_services_apiheader_PublishDateTime', substr($datetime->format("D d M Y H:i:s.u"), 0, -3));
define('SW_CONFIG_services_apiheader_Canonical', substr($datetime->format("Y-m-d H:i:s.u"), 0, -3));
define('SW_CONFIG_services_apiheader_Author', "api@connexionzuk.com");
define('SW_CONFIG_services_apiheader_Owner', "Reading Borough Council");
define('SW_CONFIG_services_apiheader_RefreshRate', "604800");
define('SW_CONFIG_services_apiheader_Max_Latency', "86400");
define('SW_CONFIG_services_apiheader_TimeToError', "1209600");
define('SW_CONFIG_services_apiheader_Schedule', "Once a week");
define('SW_CONFIG_services_apiheader_OverrideMessage', "Due to unforeseen circumstances, this feed is currently not publishable.");
define('SW_CONFIG_services_apiheader_ErrorMessage', "Due to unforeseen circumstances, this feed is currently not available.");
define('SW_CONFIG_services_apiheader_FeedInfo', "");
define('SW_CONFIG_services_apiheader_AttributionUrl', "http://www.reading-travelinfo.co.uk/");
define('SW_CONFIG_services_apiheader_AttributionText', "(c) RBC");
define('SW_CONFIG_services_apiheader_AttributionLogo', "http://www.reading-travelinfo.co.uk/images/CompanyLogos/rbclogo.gif");
define('SW_CONFIG_services_apiheader_Language', "EN");
