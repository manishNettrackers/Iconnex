...
define('SW_HTTP_APP_DIR','/ods/iconnex/');
...
define('SW_CONFIG_status_datalabel', 'Status');
define('SW_CONFIG_status_datalinelabel', 'Service');

define('SW_CONFIG_servicepatterns_datalabel', 'ServicePatterns');
define('SW_CONFIG_servicepatterns_datalinelabel', 'ServicePattern');

$t = microtime(true);
$micro = sprintf("%06d", ($t - floor($t)) * 1000000);
$datetime = new DateTime(date('Y-m-d H:i:s.'.$micro, $t));

define('SW_CONFIG_status_apiheader_Identifier', "status");
define('SW_CONFIG_status_apiheader_DisplayTitle', "Status");
define('SW_CONFIG_status_apiheader_PublishDateTime', substr($datetime->format("D d M Y H:i:s.u"), 0, -3));
define('SW_CONFIG_status_apiheader_Canonical', substr($datetime->format("Y-m-d H:i:s.u"), 0, -3));
define('SW_CONFIG_status_apiheader_Author', "api@connexionzuk.com");
define('SW_CONFIG_status_apiheader_Owner', "Reading Borough Council");
define('SW_CONFIG_status_apiheader_RefreshRate', "300");
define('SW_CONFIG_status_apiheader_Max_Latency', "60");
define('SW_CONFIG_status_apiheader_TimeToError', "600");
define('SW_CONFIG_status_apiheader_Schedule', "Once every five minutes");
define('SW_CONFIG_status_apiheader_OverrideMessage', "Due to unforeseen circumstances, this feed is currently not publishable.");
define('SW_CONFIG_status_apiheader_ErrorMessage', "Due to unforeseen circumstances, this feed is currently not available.");
define('SW_CONFIG_status_apiheader_FeedInfo', "");
define('SW_CONFIG_status_apiheader_AttributionUrl', "http://www.reading-travelinfo.co.uk/");
define('SW_CONFIG_status_apiheader_AttributionText', "(c) RBC");
define('SW_CONFIG_status_apiheader_AttributionLogo', "http://www.reading-travelinfo.co.uk/images/CompanyLogos/rbclogo.gif");
define('SW_CONFIG_status_apiheader_Language', "EN");

// Graph Defaults
define("SW_GRAPH_ENGINE", "JPGRAPH" );
