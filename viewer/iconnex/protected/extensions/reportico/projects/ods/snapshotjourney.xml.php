<?php
    ...
    $golap = "'Tooltips=Vehicle Code;Lateness Band;Route,'.
        ...
        'Filters=Route;Service;Vehicle Code;Vehicle Status;Lateness Band;Trip Type;Trip Status;Driver Name,'.
        'FilterMoveAlerts=Lateness Band>Very Early/Very Late,'.
        'RenderType=Despatcher,'.
        'RenderElements=Operator Code;Route;Service;Vehicle Code;Trip Type;Trip Status;Lateness;Vehicle Status;Bearing,'.
        'Metric=Lateness,'.
        'PosColor=#ff0000,'.
        'Negcolor=#0000ff,'.
        'ZeroColor=#00ff00,'.
