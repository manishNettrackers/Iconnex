<?php /* Smarty version 2.6.26, created on 2012-12-09 14:16:53
         compiled from fullscreen_prepare.tpl */ ?>
...
<FORM class="swPrpForm" id="critform" name="topmenu" method="GET" action="<?php echo $this->_tpl_vars['SCRIPT_SELF']; ?>
">
...
"-->
    				<input type="submit" id="fullScreenReset" name="clearform" value="<?php echo $this->_tpl_vars['T_RESET']; ?>
">
			</div>
