...
if(!window.jQuery)
{
	var script = document.createElement('script');
   	script.type = "text/javascript";
   	script.src = "{/literal}{$JSPATH}{literal}/jquery.js";
   	document.getElementsByTagName('head')[0].appendChild(script);

   	script.type = "text/javascript";
   	script.src = "{/literal}{$JSPATH}{literal}/ui/jquery.ui.core.js";
   	document.getElementsByTagName('head')[0].appendChild(script);

   	script.type = "text/javascript";
   	script.src = "{/literal}{$JSPATH}{literal}/ui/jquery.ui.datepicker.js";
   	document.getElementsByTagName('head')[0].appendChild(script);
}
</script>
{/literal}
...
<!---->
		<TR id="swPrpCriteriaBody">
			...
			<div id="swPrpSubmitPane">
    				<input type="submit" id="fullScreenGo" name="fullScreenGo" value="{$T_GO}">
