...
delete from cent_user where usernm = "nandd";
...
insert into cent_user values ( 0, "nandd", "nandd", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
delete from cent_user where usernm = "wberks";
delete from cent_user where usernm = "wokingham";
insert into cent_user values ( 0, "wokingham", "wokingham", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
insert into cent_user values ( 0, "wberks", "wberks", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
delete from cent_user where usernm = "ctombs";
insert into cent_user values ( 0, "ctombs", "ctombs", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
delete from cent_user where usernm = "sbell";
insert into cent_user values ( 0, "sbell", "sbell", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
delete from cent_user where usernm = "sgold";
insert into cent_user values ( 0, "sgold", "sgold", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
delete from cent_user where usernm in ( "rbrookes", "mramsey" );
delete from cent_user where usernm in ( "rbrooks", "mramsay" );
insert into cent_user values ( 0, "rbrooks", "rbrooks", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
insert into cent_user values ( 0, "mramsay", "mramsay", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
delete from cent_user where usernm in ( "tlake", "brackf" );
insert into cent_user values ( 0, "tlake", "tlake", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
insert into cent_user values ( 0, "brackf", "brackf", NULL, "", "", NULL, NULL, "en_gb", "MASTER");
...
insert into iconnex_application values ( 5, "Vehicle Position", 'criteria&target_menu=&project=ods&xmlin=vehiclepos.xml' , 1,0,0,0,0,0,"",0);
...
insert into iconnex_application values ( 12, "Despatcher Map Veh", 'criteria&target_menu=&project=rti&xmlin=despatcher.xml' , 1,0,0,0,0,0,"",1);
...
insert into iconnex_application values ( 30, "Daily Tracking Performance", 'criteria&MANUAL_date_FROMDATE=TODAY&MANUAL_date_TODATE=TODAY&target_menu=&project=rti&xmlin=perfsummaryroutecustomer.xml' , 0,1,0,1,1,0,"",0);
...
insert into iconnex_application values ( 33, "Current Tracking Issues", 'criteria&MANUAL_date_FROMDATE=TODAY&MANUAL_date_TODATE=TODAY&target_menu=&project=rti&xmlin=trackingissues.xml' , 0,1,0,1,1,0,"",0);
...
insert into iconnex_application values ( 35, "Early/Late Vehicles", 'criteria&MANUAL_date_FROMDATE=TODAY&MANUAL_date_TODATE=TODAY&target_menu=&project=rti&xmlin=laterunners.xml&MANUAL_showLateJourneys=1' , 0,1,0,0,0,1,"",1);
insert into iconnex_application values ( 36, "Current Trips", 'criteria&MANUAL_showCurrent=1&MANUAL_date_FROMDATE=TODAY&MANUAL_date_TODATE=TODAY&target_menu=&project=rti&xmlin=timetablemonitor.xml' , 0,1,0,0,0,1,"",0);
...
insert into iconnex_application values ( 47, "Login Audit Trail", 'criteria&target_menu=&project=infohost&xmlin=login_audit.xml' , 0,1,0,1,1,0,"",0);
insert into iconnex_application values ( 48, "Login Audit Report", 'criteria&target_menu=&project=infohost&xmlin=login_audit.xml' , 0,1,0,1,1,0,"",0);
...
insert into iconnex_application values ( 59, "Vehicle Position Events", 'criteria&target_menu=&project=ods&xmlin=vehicleposevent.xml' , 1,0,0,0,0,0,"",0);
...
insert into iconnex_application values ( 60, "Roadworks", 'criteria&target_menu=&project=ods&xmlin=works.xml&target_menu=' , 1,1,0,0,0,1,"",0);
insert into iconnex_application values ( 61, "Tracking Problems", 'criteria&MANUAL_date_FROMDATE=TODAY&MANUAL_date_TODATE=TODAY&target_menu=&project=rti&xmlin=trackingproblems.xml' , 0,1,0,0,0,0,"",0);
insert into iconnex_application values ( 62, "Latest Positional Events", 'criteria&target_menu=&project=ods&xmlin=vehicleeventvisualizer.xml' , 1,0,0,0,0,0,"",0);
insert into iconnex_application values ( 63, "Real Time Lateness", 'criteria&target_menu=&project=ods&xmlin=realtimelateness.xml' , 1,0,0,0,0,0,"",0);
insert into iconnex_application values ( 64, "Stop Average Lateness", 'criteria&target_menu=&project=ods&xmlin=stopavglateness.xml' , 1,0,0,0,0,0,"",0);
insert into iconnex_application values ( 65, "Vehicle Tracking Performance", 'criteria&target_menu=&project=rti&xmlin=perfsummaryvehicle.xml' , 1,0,0,0,0,0,"",0);
...
--insert into iconnex_menuitem select 1, 6, app_id, "SIDEPANEL" from iconnex_application where app_name = "Vehicle Position";
--insert into iconnex_menuitem select 1, 7, app_id, "SIDEPANEL" from iconnex_application where app_name = "Vehicle Position Events";
insert into iconnex_menuitem select 1, 8, app_id, "SIDEPANEL" from iconnex_application where app_name = "Latest Positional Events";
...
--insert into iconnex_menuitem select 1, 19, app_id, "SIDEPANEL" from iconnex_application where app_name = "Real Time Lateness";
insert into iconnex_menuitem select 1, 20, app_id, "SIDEPANEL" from iconnex_application where app_name = "Stop Average Lateness";

insert into iconnex_menu values ( 2, "Bus Stops" );
...
insert into iconnex_menuitem select 4, 7, app_id, "SIDEPANEL" from iconnex_application where app_name = "Car Parks";
insert into iconnex_menuitem select 4, 8, app_id, "SIDEPANEL" from iconnex_application where app_name = "Variable Message Signs";
insert into iconnex_menuitem select 4, 9, app_id, "SIDEPANEL" from iconnex_application where app_name = "Roadworks";
...
insert into iconnex_menuitem select 6, 1, app_id, "FULLSCREEN" from iconnex_application where app_name = "Daily Tracking Performance";
insert into iconnex_menuitem select 6, 2, app_id, "FULLSCREEN" from iconnex_application where app_name = "Vehicle Tracking Performance";
--insert into iconnex_menuitem select 6, 3, app_id, "SIDEPANEL" from iconnex_application where app_name = "Inactive Screens";
--insert into iconnex_menuitem select 6, 4, app_id, "FULLSCREEN" from iconnex_application where app_name = "Out of Date Vehicles";
insert into iconnex_menuitem select 6, 5, app_id, "FULLSCREEN" from iconnex_application where app_name = "Current Tracking Issues";
--insert into iconnex_menuitem select 6, 7, app_id, "FULLSCREEN" from iconnex_application where app_name = "Tracking Performance Detail";
insert into iconnex_menuitem select 6, 8, app_id, "FULLSCREEN" from iconnex_application where app_name = "Operator Tracking Summary";
insert into iconnex_menuitem select 6, 9, app_id, "FULLSCREEN" from iconnex_application where app_name = "Route Tracking Performance By Operator";
insert into iconnex_menuitem select 6, 10, app_id, "SIDEPANEL" from iconnex_application where app_name = "Tracking Problems";

insert into iconnex_menu values ( 11, "Analysis Reports" );
insert into iconnex_menuitem select 11, 6, app_id, "FULLSCREEN" from iconnex_application where app_name = "Time Between Points";
insert into iconnex_menuitem select 11, 2, app_id, "FULLSCREEN" from iconnex_application where app_name = "Time Between Points Banded";
insert into iconnex_menuitem select 11, 3, app_id, "FULLSCREEN" from iconnex_application where app_name = "Stop Timetable Compliance";
#insert into iconnex_menuitem select 11, 4, app_id, "FULLSCREEN" from iconnex_application where app_name = "Interval Profile Generation";
insert into iconnex_menuitem select 11, 5, app_id, "FULLSCREEN" from iconnex_application where app_name = "Trip Duration Report";
insert into iconnex_menuitem select 11, 6, app_id, "FULLSCREEN" from iconnex_application where app_name = "Daily Tracking Performance By Route";
insert into iconnex_menuitem select 11, 7, app_id, "FULLSCREEN" from iconnex_application where app_name = "Route Lateness";
...
--insert into iconnex_menuitem select 8, 1, app_id, "FULLSCREEN" from iconnex_application where app_name = "Daily Tracking Performance";
--insert into iconnex_menuitem select 8, 2, app_id, "FULLSCREEN" from iconnex_application where app_name = "Inactive Screens";
--insert into iconnex_menuitem select 8, 3, app_id, "FULLSCREEN" from iconnex_application where app_name = "Out of Date Vehicles";
--insert into iconnex_menuitem select 8, 4, app_id, "FULLSCREEN" from iconnex_application where app_name = "Compliance Table";
...
insert into iconnex_menuitem select 9, 8, app_id, "SIDEPANEL" from iconnex_application where app_name = "Latest Positional Events";
insert into iconnex_menuitem select 9, 20, app_id, "SIDEPANEL" from iconnex_application where app_name = "Stop Average Lateness";

insert into iconnex_menu values ( 10, "Locations" );
insert into iconnex_menuitem select 10, 3, app_id, "SIDEPANEL" from iconnex_application where app_name = "Stop Timetable";
--insert into iconnex_menuitem select 10, 4, app_id, "SIDEPANEL" from iconnex_application where app_name = "Bus Stops";
--insert into iconnex_menuitem select 10, 6, app_id, "FULLSCREEN" from iconnex_application where app_name = "Stop Messages";
insert into iconnex_menuitem select 10, 7, app_id, "SIDEPANEL" from iconnex_application where app_name = "Car Parks";
insert into iconnex_menuitem select 10, 8, app_id, "SIDEPANEL" from iconnex_application where app_name = "Variable Message Signs";
insert into iconnex_menuitem select 10, 9, app_id, "SIDEPANEL" from iconnex_application where app_name = "Roadworks";
...
-- Bus Operator Menus
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 1, 0, 1, 0 FROM cent_user where usernm in ("first", "rgb", "thames", "rbc", "transept", "wokingham", "wberks", "rgbdesp" , "nandd", "sgold", "sbell", "jhall", "ctombs", "rbrooks", "mramsay" );
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 6, 0, 1, 0 FROM cent_user where usernm in ("first", "rgb", "thames", "rbc", "transept", "wokingham", "wberks", "rgbdesp" , "nandd", "sgold", "sbell", "jhall", "ctombs", "rbrooks", "mramsay" );
--insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 5, 0, 1, 0 FROM cent_user where usernm in ("first", rgbdesp" ;
--insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 8, 0, 1, 0 FROM cent_user where usernm in ("first", rgbdesp" ;
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 10, 0, 1, 0 FROM cent_user where usernm in ("first", "rgb", "thames", "rbc", "transept", "wokingham", "wberks", "rgbdesp" , "nandd", "sgold", "sbell", "jhall", "ctombs", "rbrooks", "mramsay" );
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 11, 0, 1, 0 FROM cent_user where usernm in ("first", "rgb", "thames", "rbc", "transept", "wokingham", "wberks", "rgbdesp" , "nandd", "sgold", "sbell", "jhall", "ctombs", "rbrooks", "mramsay" );

-- Authority Menus
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 2, 0, 1, 0 FROM cent_user where usernm in ( "rbc", "mallen", "brackf" ) ;
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 4, 0, 1, 0 FROM cent_user where usernm in ( "rbc" , "mallen", "tlake", "brackf"  );
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 9, 0, 1, 0 FROM cent_user where usernm in ( "rbc" , "mallen", "brackf"  );
insert into iconnex_menu_user ( user_id, menu_id, autorun, show_accordion, show_buttons) SELECT userid, 6, 0, 1, 0 FROM cent_user where usernm in ( "brackf"  );
...
SELECT userid, 3, 1, 0, 1 FROM cent_user where userid >= 55 and usernm not in ("rgb", "nandd", "rgbdesp", "weaway", "rbc", "admin", "jhall", "sgold", "sbell", "wberks", "mallen", "rbrooks", "mramsay", "brackf", "tlake" );
...
create table "dbmaster".iconnex_workspace_item 
(
...
grant select on "dbmaster".iconnex_workspace_item to "centrole" as "dbmaster";
grant update on "dbmaster".iconnex_workspace_item to "centrole" as "dbmaster";
grant insert on "dbmaster".iconnex_workspace_item to "centrole" as "dbmaster";
grant delete on "dbmaster".iconnex_workspace_item to "centrole" as "dbmaster";

-- A report/dashboard that is part of a users workspace
alter table "dbmaster".iconnex_workspace_item add constraint (foreign key 
    (workspace_id) references "dbmaster".iconnex_workspace);

-- A workspace parameter
create table "dbmaster".iconnex_workspace_parameter 
(
	workspace_id	    INTEGER NOT NULL,
...
grant select on "dbmaster".iconnex_workspace_parameter to "centrole" as "dbmaster";
grant update on "dbmaster".iconnex_workspace_parameter to "centrole" as "dbmaster";
grant insert on "dbmaster".iconnex_workspace_parameter to "centrole" as "dbmaster";
grant delete on "dbmaster".iconnex_workspace_parameter to "centrole" as "dbmaster";

alter table "dbmaster".iconnex_workspace_parameter add constraint (foreign key 
    (workspace_item_id) references "dbmaster".iconnex_workspace_item);
